//
// Created by slice on 1/9/25.
//

#ifndef TREESHADERINSTANCEDPROGRAM_H
#define TREESHADERINSTANCEDPROGRAM_H

#include "../BaseShaderProgram.h"


class TreeShaderInstancedProgram : public BaseShaderProgram {
public:
    TreeShaderInstancedProgram() : BaseShaderProgram("../src/Shaders/TreeShaderInstance/shader.vert", "../src/Shaders/TreeShaderInstance/shader.frag") {
...
#endif //TREESHADERINSTANCEDPROGRAM_H
