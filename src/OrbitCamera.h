...
private:
    void updateViewMatrix() {
        ...
        glm::vec3 camPos(0.0f, 0.0f, m_orbitDistance);

        camPos = glm::vec3(rotationY * rotationX * glm::vec4(camPos, 1.0f));

        m_view = glm::lookAt(camPos, glm::vec3(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    }
